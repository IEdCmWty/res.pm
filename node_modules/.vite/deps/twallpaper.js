// ../../node_modules/.bun/twallpaper@2.1.2/node_modules/twallpaper/dist/index.es.js
function C(h) {
  const t = L(h);
  return t ? {
    r: parseInt(t[1], 16),
...
var q = class {
  ...
  drawOnWheel() {
    ...
    this.scrollDelta %= this.scrollTails, t = t > 0 ? Math.floor(t) : Math.ceil(t), t && (this.changeTail(t), this.drawGradient()), this.scrollTicking = false;
  }
  ...
  drawGradient() {
    const t = this.curPosition(this.phase, this.tail);
  ...
  doAnimate() {
    ...
    this.timestamp = t, this.changeTail(1), this.drawGradient(), this.requestAnimate();
  }
  /**
...
//# sourceMappingURL=twallpaper.js.map
